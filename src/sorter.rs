...
use clap::ValueEnum;
use crate::properties::{dir_props::set_directory_properties, file_props::FileProperties, traits::{ChildItems, Dates, Info}};
...
fn sort_selector(sort_method: &SortFlags, parent_path: &PathBuf, file: &FileProperties) -> Option<PathBuf>{
    match sort_method {
        SortFlags::SDA => {
